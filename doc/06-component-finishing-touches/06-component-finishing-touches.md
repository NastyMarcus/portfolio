...
Completing this portfolio project has improved my understanding of software development, especially in the context of designing, testing, and iterating on a component like the Playlist class. Working through this project allowed me to engage with a software lifecycle similar to what is seen in real-world development.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

This project highlighted certain gaps in my knowledge, particularly around unit testing and handling abstract classes and interfaces effectively in Java. To address these gaps, I reviewed additional resources on JUnit and spent extra time testing my understanding with small example projects.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

My perspective on software development has broadened, and I still enjoy it. The project reinforced that development is not only about coding but also about planning, testing, and re-evaluating design decisions. I realized that I enjoy the problem-solving aspect of software development, particularly in how a single problem can have multiple solutions, each with its own trade-offs.
...
Designing software components with interfaces and abstract classes. Implementing modular design to separate core and extended functionality.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

- Developed a reusable software component with core and enhanced functionality.
- Designed and implemented unit tests to verify component correctness.
- Applied modular and object-oriented design principles in Java.

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

This project made me more interested in backend and software component development. I enjoyed designing a system with clear interfaces and building its extended functionalities.
...
Study advanced software design patterns and architectural principles. I would also consider reaching out to mentors in the field of backend development or software architecture, including professors and industry professionals on LinkedIn.
